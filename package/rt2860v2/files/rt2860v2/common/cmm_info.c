...
#define	LINE_LEN	(4+65+20+23+9+7+7+3)  /*add by duxt*/
	...
	IN	RTMP_IOCTL_INPUT_STRUCT	*wrq)
{
	...
	/*add by duxt*/sprintf(msg+strlen(msg),"%-4s%-65s%-20s%-23s%-9s%-7s%-7s%-3s\n",
